                    ...
                    <div class=" col m3">
                        <div class="form-group">
                            ...
                            <span class="help-block">
                                <asp:RequiredFieldValidator ID="requiredEmployee" runat="server" ControlToValidate="ddlEmployeeName" ValidationGroup="vt" InitialValue="0"
                                    SetFocusOnError="true" ErrorMessage="Select Employee ??" ForeColor="Red"></asp:RequiredFieldValidator>
                            </span>
                        ...
                        <div class="row">
                            ...
                            <div class=" col m2 ">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlTaskType" runat="server" class="form-control" placeholder="" AutoPostBack="true"
                                        ClientIDMode="Static" OnSelectedIndexChanged="ddlTaskType_SelectedIndexChanged">
                                    </asp:DropDownList>
                                                    ...
                                                    <asp:GridView ID="GridTask" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Task Details" HeaderStyle-CssClass="autostyle2">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Label8" runat="server" Text='<%# Eval("TaskDetails")  %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>

                                                            <asp:TemplateField HeaderText="Work Date" HeaderStyle-CssClass="autostyle2" SortExpression="WorkDate">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Label9" runat="server" Text='<%# Eval("WorkDate","{0:dd/MMM/yy}")  %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
