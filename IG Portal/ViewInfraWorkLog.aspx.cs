...
namespace IG_Portal
{
    public partial class ViewInfraWorkLog : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindSupportWorkLog(Session["SupportHistoryID"].ToString());

            }
        }


        public void BindSupportWorkLog(string supportID)
        {
            DataTable dtSupportHistory;

            dtSupportHistory = objTask.GetInfraWorkLog(supportID);
