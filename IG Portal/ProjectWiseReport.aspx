<%@ Page Title="" Language="C#" MasterPageFile="~/PortalMaster.Master" AutoEventWireup="true" CodeBehind="ProjectWiseReport.aspx.cs" Inherits="IG_Portal.ProjectWiseReport" %>
        ...
        <div class="portlet-body">
            ...
            <div class="form-body">
                <div class="row" align="center">
                    <h4 class="header2">Project Wise Report</h4>
                   <%-- <asp:Label ID="lbltitle" runat="server" Text="Project Wise Report" Font-Bold="true" Font-Size="Large"></asp:Label>--%>
                </div>
                <br />
                <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col m12" align="right">
                                        <button class="btn green" runat="server" onserverclick="btnExport_Click" visible="false" id="btExport"><i class="fa fa-download"></i>Export</button>
