...
namespace IG_Portal
{
    public partial class MonthlyProjectHoursByEmployeeReport : System.Web.UI.Page
    {
        ...
        public void BindGridTask()
        {
            ...
            //{
            dtTaskDetails = objTask.GetMonthlyProjectHoursSpent(Convert.ToInt32(Session["CompanyID"].ToString()), ddlMonthName.SelectedValue,ddlEmployeeName.SelectedValue, ddlProjectName.SelectedValue,ddlYear.SelectedValue);
            GridTask.DataSource = dtTaskDetails;
            GridTask.DataBind();
            GridFillTask();
            // }
