<%@ Page Title="" Language="C#" MasterPageFile="~/PortalMaster.Master" AutoEventWireup="true" CodeBehind="ViewInfraWorkLog.aspx.cs" Inherits="IG_Portal.ViewInfraWorkLog" %>
        ...
        <div class="portlet-body">
            ...
            <div class="form-body">
                <div class="row" align="center">
                    <h4 class="header2">Support Work Log</h4>
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="table-scrollable">
                                        <asp:GridView ID="GridSupport" runat="server"  AutoGenerateColumns="False"
                                            class="striped" AllowSorting="true" 
                                            GridLines="None" OnSorting="GridSupport_Sorting"   DataKeyNames="ID"
                                            ...
                                            <Columns>
                                             ...
                                             <asp:TemplateField HeaderText="Post By" HeaderStyle-CssClass="autostyle2" SortExpression="PostBy">
                                                  ...
                                                  <asp:TemplateField HeaderText="Work Date" HeaderStyle-CssClass="autostyle2" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("WorkDate","{0:dd/MMM/yy}")  %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                 <asp:TemplateField HeaderText="Start Time" HeaderStyle-CssClass="autostyle2" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("StartTime")  %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                 <asp:TemplateField HeaderText="End Time" HeaderStyle-CssClass="autostyle2" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label13" runat="server" Text='<%# Eval("EndTime")  %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Work Hours" HeaderStyle-CssClass="autostyle2" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label9" runat="server" Text='<%# Eval("WorkTime")  %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
