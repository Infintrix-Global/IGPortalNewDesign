...
namespace IG_Portal
{
    public partial class ProjectWiseReport : System.Web.UI.Page
    {
        ...
        public void BindEmployeeMaster()
        {
                ...
                ddlEmployeeName.DataSource = objcommon.GetEmployeeMasterByProjectDate(Convert.ToInt32(Convert.ToInt32(ddlProjectName.SelectedValue)), txtFromDate.Text, txtToDate.Text);
        ...
        public void BindProjectMaster()
        {
                ...
                ddlProjectName.DataSource = objcommon.GetProjectMasterByDate(Convert.ToInt32(Session["CompanyID"].ToString()), txtFromDate.Text, txtToDate.Text);
