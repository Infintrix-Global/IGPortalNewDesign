<%@ Page Title="" Language="C#" MasterPageFile="~/PortalMaster.Master" AutoEventWireup="true" CodeBehind="ViewInfraSupportTicket.aspx.cs" Inherits="IG_Portal.ViewInfraSupportTicket" %>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="table-scrollable">
                                        <asp:GridView ID="GridSupport" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                            ...
                                            ShowHeaderWhenEmpty="True" Width="100%" OnRowCommand="GridSupport_RowCommand"  OnRowDataBound="GridSupport_RowDataBound"  >
                                            <Columns>
