<%@ Page Title="" Language="C#" MasterPageFile="~/PortalMaster.Master" AutoEventWireup="true" CodeBehind="AdminDashBoardWM.aspx.cs" Inherits="IG_Portal.SuperAdminDashBoard" Debug="true" %>
            ...
            <div class="row">
                <div class="work-collections">
                                ...
                                <li class="collection-item">
                                    <asp:GridView ID="GridBug" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Open Bugs" HeaderStyle-CssClass="autostyle2">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label8" runat="server" Text='<%# Eval("OpenBug")  %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <div class="row">
                                    ...
                                    <asp:GridView ID="GridMOM" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Meeting Date" HeaderStyle-CssClass="autostyle2">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label27" runat="server" Text='<%# Eval("MeetingDate","{0:dd/MMM/yy}")  %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                      ...
                      <div class="row">
                       <div class="col s12 m12 l6">
                            <ul id="ul3" class="collection">
                                <li class="collection-item avatar indigo" style="color: white; font-weight: bold"><span class="collection-header">Employee Wise Open Bugs</span>

                                </li>
                                <li class="collection-item">
                                    <asp:GridView ID="GridEmployeeBugs" runat="server" AutoGenerateColumns="False"
                                        class="striped" AllowSorting="true"
                                        GridLines="None"
                                        ShowHeaderWhenEmpty="True" Width="100%">
                                        <Columns>
                            ...
                            <div class="col s12 m12 l6">
                            <ul id="ul3" class="collection">
                                <li class="collection-item avatar indigo" style="color: white; font-weight: bold"><span class="collection-header">Employee Wise Completed Bugs</span>

                                </li>
                                <li class="collection-item">
                                    <asp:GridView ID="GridEmployeeCompletedBugs" runat="server" AutoGenerateColumns="False"
                                        class="striped" AllowSorting="true"
                                        GridLines="None"
                                        ShowHeaderWhenEmpty="True" Width="100%">
                                        <Columns>
